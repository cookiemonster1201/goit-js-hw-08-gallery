...
refs.gallery.insertAdjacentHTML(
  "afterbegin",
  galleryItems.map((item) => createGalleryMarkup(item)).join("")
);
...
const srcArray = galleryItems.map((item) => item.original);

const onGalleryNavClick = (arr) => (e) => {
...
window.addEventListener("keydown", onGalleryNavClick(srcArray));
